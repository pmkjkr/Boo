...
import com.donga.examples.bumin.retrofit.retrofitGrad.Master;
...
public class GrageFragment extends Fragment {
    ...
    @BindView(R.id.tv_avgGrade) TextView tv_avgGrade;
    @BindView(R.id.tv_early) TextView tv_early;
    @BindView(R.id.tv_smart) TextView tv_smart;

    @BindView(R.id.kyo_02) TextView kyo_02;
    @BindView(R.id.kyo_03) TextView kyo_03;
    @BindView(R.id.kyo_04) TextView kyo_04;
    @BindView(R.id.kyo_05) TextView kyo_05;
    @BindView(R.id.kyo_11) TextView kyo_11;
    @BindView(R.id.kyo_12) TextView kyo_12;
    @BindView(R.id.kyo_13) TextView kyo_13;
    @BindView(R.id.kyo_14) TextView kyo_14;
    @BindView(R.id.kyo_21) TextView kyo_21;
    @BindView(R.id.kyo_22) TextView kyo_22;
    @BindView(R.id.kyo_23) TextView kyo_23;
    @BindView(R.id.kyo_24) TextView kyo_24;
    @BindView(R.id.kyo_31) TextView kyo_31;
    @BindView(R.id.kyo_32) TextView kyo_32;
    @BindView(R.id.kyo_33) TextView kyo_33;
    @BindView(R.id.kyo_34) TextView kyo_34;

    @BindView(R.id.jun_01) TextView jun_01;
    @BindView(R.id.jun_02) TextView jun_02;
    @BindView(R.id.jun_11) TextView jun_11;
    @BindView(R.id.jun_12) TextView jun_12;
    @BindView(R.id.jun_21) TextView jun_21;
    @BindView(R.id.jun_22) TextView jun_22;
    @BindView(R.id.jun_31) TextView jun_31;
    @BindView(R.id.jun_32) TextView jun_32;

    @BindView(R.id.ja_1) TextView ja_1;
    @BindView(R.id.ja_2) TextView ja_2;
    @BindView(R.id.ja_3) TextView ja_3;
        ...
        try {
            ...
            call.enqueue(new Callback<Master>() {
                ...
                public void onResponse(Call<com.donga.examples.bumin.retrofit.retrofitGrad.Master> call, Response<Master> response) {
                    Log.i("GRADE onResponse", String.valueOf(response.body().getResult_code()));
...
//-\d+ -> 음수
                ...
                @Override
                public void onFailure(Call<com.donga.examples.bumin.retrofit.retrofitGrad.Master> call, Throwable t) {
                    Log.i("SCHE onFailure", "...");
                    t.printStackTrace();
                    appendLog.appendLog("SCHE onFailure");
                }
            });
        } catch (Exception e) {
            e.printStackTrace();
