...
public class PartListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView title = (TextView) convertView.findViewById(R.id.sub_name_part);
        TextView dis = (TextView) convertView.findViewById(R.id.dis_part);
        TextView grade = (TextView) convertView.findViewById(R.id.grade_part);
        TextView achiev = (TextView) convertView.findViewById(R.id.ac_part);
        ...
        dis.setText(listViewItem.getDis());
